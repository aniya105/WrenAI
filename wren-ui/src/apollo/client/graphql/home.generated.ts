...
export type SubmitClarificationMutationVariables = Types.Exact<{
  queryId: Types.Scalars['String'];
  answers: Array<Types.Scalars['JSON']> | Types.Scalars['JSON'];
}>;


export type SubmitClarificationMutation = { __typename?: 'Mutation', submitClarification: { __typename?: 'Task', id: string } };
...
export const SubmitClarificationDocument = gql`
  ...
  submitClarification(queryId: $queryId, answers: $answers) {
    ...
    `;
export type SubmitClarificationMutationFn = Apollo.MutationFunction<SubmitClarificationMutation, SubmitClarificationMutationVariables>;

/**
 * __useSubmitClarificationMutation__
 *
 * To run a mutation, you first call `useSubmitClarificationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitClarificationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [submitClarificationMutation, { data, loading, error }] = useSubmitClarificationMutation({
 *   variables: {
 ...
 * });
 */
export function useSubmitClarificationMutation(baseOptions?: Apollo.MutationHookOptions<SubmitClarificationMutation, SubmitClarificationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SubmitClarificationMutation, SubmitClarificationMutationVariables>(SubmitClarificationDocument, options);
      }
export type SubmitClarificationMutationHookResult = ReturnType<typeof useSubmitClarificationMutation>;
export type SubmitClarificationMutationResult = Apollo.MutationResult<SubmitClarificationMutation>;
export type SubmitClarificationMutationOptions = Apollo.BaseMutationOptions<SubmitClarificationMutation, SubmitClarificationMutationVariables>;
