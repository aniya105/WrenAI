...
export default function VerticaProperties(props: Props) {
  const { mode } = props;
  ...
  return (
    <>
      ...
      >
        <Input placeholder="5433" disabled={isEditMode} />
      </Form.Item>
      <Form.Item
        label="Username"
        name="user"
      ...
      >
        <Input placeholder="Vertica database name" disabled={isEditMode} />
      </Form.Item>
